...
# Intentamos importar python-docx, si falla, avisamos
try:
    ...
    print("Por favor, ejecuta en la consola de Docker: <b>pip install python-docx</b>")
    sys.exit(1)

def generar_manual():
    print(">>> Iniciando generación del Manual Técnico...")
    
    # --- RUTA DE SALIDA OBLIGATORIA (/app/datos) ---
    ...
    if not os.path.exists(output_folder):
        try:
            ...
            # Fallback si no estamos en Docker o no hay permisos
    ...
    try:
        ...
        # --- GUARDAR CON RUTA CORREGIDA ---
        doc.save(output_path)
        print(f"✅ Documento generado con éxito en: {output_path}")
        print("⬇️ Puedes descargarlo desde la sección de Logs/Datos del panel.")
